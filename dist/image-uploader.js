(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.FileUploader = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/*!
    ...
    function CropperModal(file, options, callback) {
        ...
        this.modal = new _tingle2.default.modal({
            ...
            onOpen: function onOpen() {
                _this.cropper = new _cropperjs2.default(_this.cropperEl, options);
...
},{"cropperjs":1,"tingle.js":3}],5:[function(require,module,exports){
'use strict';

var _dropmic = require('dropmic');

var _dropmic2 = _interopRequireDefault(_dropmic);

var _cropperModal = require('./cropper-modal');
...
function _selectFile(event) {
    ...
    if (this._options.cropper) {
        this.modal = new _cropperModal2.default(file, this._options.cropperOptions, function (data) {
            _uploadFile.bind(_this2)(_this2._editId, file, data);
            _this2._editId = null;
        });
    } else {
...
function _initAddView() {
    ...
    if (this._options.sortable) {
        (0, _sortable2.default)(addView, _sortItems.bind(this));
    }
...
function _makeItemView(item) {
    ...
    if (this._options.sortable) {
        (0, _sortable2.default)(itemView, _sortItems.bind(this));
    }
...
function _initDopmic(el, item) {
    ...
    var dropmic = new _dropmic2.default(el);

    dropmic.addBtn(this._options.strings.update, function (event) {
        event.preventDefault();
        _this4._editId = item.id;
        _this4._fileInput.click();
    });

    if (this._options.deletable) {
        dropmic.addBtn(this._options.strings.delete, function (event) {
            event.preventDefault();
            if (typeof _this4._options.onDelete === "function") {
                _this4._options.onDelete(item, function () {
                    _removeItem.bind(_this4)(item);
                });
            } else {
                _removeItem.bind(_this4)(item);
            }
...
},{"./cropper-modal":4,"./sortable":6,"dropmic":2}],6:[function(require,module,exports){
'use strict';
